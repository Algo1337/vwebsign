...
typedef array Array_C__Control_ptr;
...
VV_LOCAL_SYMBOL void main__dick(void);
...
VV_LOCAL_SYMBOL void main__main(void) {
	Array_C__Control_ptr new_arr = __new_array_with_default(0, 0, sizeof(Control*), 0);
	...
	array_push((array*)&new_arr, _MOV((Control*[]){ head }));
	array_push((array*)&new_arr, _MOV((Control*[]){ body }));
	WebRoute* route = CreateRoute("nig", "/", ((voidptr)(main__dick)));
	AppendParentControl(route, head);
	ConstructTemplate(route, ((Control**)(new_arr.data)), NULL);
	println(str_intp(1, _MOV((StrIntpData[]){{_SLIT("&"), 0xfe10 ,{.d_s = isnil(route->Template) ? _SLIT("nil") : char_str(route->Template)}}})));
}
void _vinit(int ___argc, voidptr ___argv) {
