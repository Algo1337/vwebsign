...
typedef struct main__WebServer main__WebServer;
...
void eprint_space_padding(string output, int max_len);
...
time__Time time__convert_ctime(struct tm t, int nanosecond);
...
void main__test(cWS* web, cWR* r, WebRoute* route, int socket);
...
array array_slice(array a, int start, int _end) {
	...
	{
		if (start > end) {
			panic_debug(566, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),  string__plus(string__plus(string__plus(_SLIT("array.slice: invalid slice index (start>end):"), i64_str(((i64)(start)))), _SLIT(", ")), i64_str(((i64)(end)))));
			VUNREACHABLE();
		}
		if (end > a.len) {
			panic_debug(570, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),  string__plus(string__plus(string__plus(string__plus(_SLIT("array.slice: slice bounds out of range ("), i64_str(((i64)(end)))), _SLIT(" >= ")), i64_str(((i64)(a.len)))), _SLIT(")")));
			VUNREACHABLE();
		}
		if (start < 0) {
			panic_debug(574, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("slice"),  string__plus(_SLIT("array.slice: slice bounds out of range (start<0):"), int_str(start)));
			VUNREACHABLE();
		}
	}
	#endif
...
void array_push(array* a, voidptr val) {
	if (a->len < 0) {
		panic_debug(704, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("push"),  _SLIT("array.push: negative len"));
		VUNREACHABLE();
	}
	if (a->len >= _const_max_int) {
		panic_debug(707, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("push"),  _SLIT("array.push: len bigger than max_int"));
		VUNREACHABLE();
	}
	if (a->len >= a->cap) {
...
void array_push_many(array* a, voidptr val, int size) {
	...
	if (new_len > _const_max_int) {
		panic_debug(726, tos3("/home/jeff/Downloads/v/vlib/builtin/array.v"), tos3("builtin"), tos3("push_many"),  _SLIT("array.push_many: new len exceeds max_int"));
		VUNREACHABLE();
	}
	if (new_len >= a->cap) {
...
void array_insert_noscan(array* a, int i, voidptr val) {
	...
	if (a->len == _const_max_int) {
		panic_debug(178, tos3("/home/jeff/Downloads/v/vlib/builtin/array_d_gcboehm_opt.v"), tos3("builtin"), tos3("insert_noscan"),  _SLIT("array.insert_noscan: a.len reached max_int"));
		VUNREACHABLE();
	}
...
voidptr array_pop_noscan(array* a) {
	if (a->len == 0) {
		panic_debug(223, tos3("/home/jeff/Downloads/v/vlib/builtin/array_d_gcboehm_opt.v"), tos3("builtin"), tos3("pop_noscan"),  _SLIT("array.pop: array is empty"));
		VUNREACHABLE();
	}
...
void array_push_noscan(array* a, voidptr val) {
	if (a->len < 0) {
		panic_debug(272, tos3("/home/jeff/Downloads/v/vlib/builtin/array_d_gcboehm_opt.v"), tos3("builtin"), tos3("push_noscan"),  _SLIT("array.push_noscan: negative len"));
		VUNREACHABLE();
	}
	if (a->len >= _const_max_int) {
		panic_debug(275, tos3("/home/jeff/Downloads/v/vlib/builtin/array_d_gcboehm_opt.v"), tos3("builtin"), tos3("push_noscan"),  _SLIT("array.push_noscan: len bigger than max_int"));
		VUNREACHABLE();
	}
	if (a->len >= a->cap) {
		array_ensure_cap_noscan(a, (int)(a->len + 1));
...
void array_push_many_noscan(array* a, voidptr val, int size) {
	...
	i64 new_len = (i64)(((i64)(a->len)) + ((i64)(size)));
	if (new_len > _const_max_int) {
		panic_debug(294, tos3("/home/jeff/Downloads/v/vlib/builtin/array_d_gcboehm_opt.v"), tos3("builtin"), tos3("push_many_noscan"),  _SLIT("array.push_many_noscan: new len exceeds max_int"));
		VUNREACHABLE();
	}
	if (a->data == val && a->data != 0) {
		array copy = array_clone(a);
		...
		#if defined(__linux__) && !defined(_VFREESTANDING)
		{
			...
			#else
			{
				...
				for (int i = 0; i < nr_actual_frames; ++i) {
					string sframe = tos2(((u8*)(csymbols[i])));
					...
					string cmd = string__plus(string__plus(string__plus(_SLIT("addr2line -e "), executable), _SLIT(" ")), addr);
					...
					output = string__plus(string_trim_chars(output, _SLIT(" \t\n"), TrimMode__trim_both), _SLIT(":"));
					if (pclose(f) != 0) {
						eprintln(sframe);
						continue;
					}
...
VNORETURN void panic_option_not_set(string s) {
	panic_debug(109, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_option_not_set"),  string__plus(string__plus(_SLIT("option not set ("), s), _SLIT(")")));
	VUNREACHABLE();
	while(1);
}
VNORETURN void panic_result_not_set(string s) {
	panic_debug(116, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_result_not_set"),  string__plus(string__plus(_SLIT("result not set ("), s), _SLIT(")")));
	VUNREACHABLE();
	while(1);
}
...
VNORETURN void panic_n(string s, i64 number1) {
	panic_debug(181, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_n"),  string__plus(s, i64_str(number1)));
	VUNREACHABLE();
	while(1);
}
VNORETURN void panic_n2(string s, i64 number1, i64 number2) {
	panic_debug(187, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("panic_n2"),  string__plus(string__plus(string__plus(s, i64_str(number1)), _SLIT(", ")), i64_str(number2)));
	VUNREACHABLE();
	while(1);
}
void eprintln(string s) {
...
VNORETURN void _memory_panic(string fname, isize size) {
	...
	eprintln(_SLIT(")"));
	panic_debug(419, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("_memory_panic"),  _SLIT("memory allocation failure"));
	VUNREACHABLE();
	while(1);
}
u8* _v_malloc(isize n) {
...
inline int v_fixed_index(int i, int len) {
	...
	{
		if (i < 0 || i >= len) {
			panic_debug(789, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin.c.v"), tos3("builtin"), tos3("v_fixed_index"),  string__plus(string__plus(string__plus(string__plus(_SLIT("fixed array index out of range (index: "), i64_str(((i64)(i)))), _SLIT(", len: ")), i64_str(((i64)(len)))), _SLIT(")")));
			VUNREACHABLE();
		}
	}
	#endif
...
VNORETURN void panic_lasterr(string base) {
	panic_debug(24, tos3("/home/jeff/Downloads/v/vlib/builtin/builtin_nix.c.v"), tos3("builtin"), tos3("panic_lasterr"),  string__plus(base, _SLIT(" unknown")));
	VUNREACHABLE();
	while(1);
}
...
inline void map_ensure_extra_metas(map* m, u32 probe_count) {
	if (((probe_count << 1U)) == m->extra_metas) {
		...
		if (probe_count == 252U) {
			panic_debug(405, tos3("/home/jeff/Downloads/v/vlib/builtin/map.v"), tos3("builtin"), tos3("ensure_extra_metas"),  _SLIT("Probe overflow"));
			VUNREACHABLE();
		}
	}
}
...
string tos(u8* s, int len) {
	if (s == 0) {
		panic_debug(106, tos3("/home/jeff/Downloads/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos"),  _SLIT("tos(): nil string"));
		VUNREACHABLE();
	}
...
string tos2(u8* s) {
	if (s == 0) {
		panic_debug(123, tos3("/home/jeff/Downloads/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos2"),  _SLIT("tos2: nil string"));
		VUNREACHABLE();
	}
...
string tos3(char* s) {
	if (s == 0) {
		panic_debug(140, tos3("/home/jeff/Downloads/v/vlib/builtin/string.v"), tos3("builtin"), tos3("tos3"),  _SLIT("tos3: nil string"));
		VUNREACHABLE();
	}
...
bool string__eq(string s, string a) {
	if (s.str == 0) {
		panic_debug(760, tos3("/home/jeff/Downloads/v/vlib/builtin/string.v"), tos3("builtin"), tos3("=="),  _SLIT("string.eq(): nil string"));
		VUNREACHABLE();
	}
	if (s.len != a.len) {
		return false;
...
string string_substr(string s, int start, int _end) {
	...
	#if !defined(CUSTOM_DEFINE_no_bounds_checking)
	{
		if (start > end || start > s.len || end > s.len || start < 0 || end < 0) {
			panic_debug(1130, tos3("/home/jeff/Downloads/v/vlib/builtin/string.v"), tos3("builtin"), tos3("substr"),  string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(_SLIT("substr("), int_str(start)), _SLIT(", ")), int_str(end)), _SLIT(") out of bounds (len=")), int_str(s.len)), _SLIT(") s=")), s));
			VUNREACHABLE();
		}
	}
	#endif
...
void main__test(cWS* web, cWR* r, WebRoute* route, int socket) {
	main__index_html(web, r, route, socket);
	struct Map new_headers = NewMap();
	AppendKey(&new_headers, "Content-Type", "text/html; charset=UTF-8");
	AppendKey(&new_headers, "Connection", "close");
	SendResponse(web, socket, 200, *&new_headers, ((struct Map){.arr = NULL,.idx = 0,}), route->Template);
}
void main__main(void) {
	...
	WebRoute* new_route = CreateRoute("index", "/", ((voidptr)(main__test)));
